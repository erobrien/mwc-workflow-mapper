...
Location: YTi6qs4zhiW6d4a75A9f
Auth: token-id header injected by the credential proxy (custom-cred:backend.leadconnectorhq.com).
Output: ghl_data_build/  (roster, docs+triggers, step graphs, tags, fields, pipelines, templates)
"""
...
OUT = os.path.join(os.path.dirname(HERE), "ghl_data_build")
